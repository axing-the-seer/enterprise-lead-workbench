...
- `POST /auth/v1/signup`: disabled in Enterprise Lead Workbench; users are provisioned by the protected first-administrator flow, an authenticated administrator, or approved organization SSO.
